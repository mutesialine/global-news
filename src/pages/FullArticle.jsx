...
const FullArticle = () => {
  ...
  return (
    <div className="pt-20 pb-28 px-12">
      <Link to="/" className="bg-gray-200 p-2 rounded-md hover:opacity-70">
        Back to Home
      </Link>
      <div className="text-black flex flex-col md:flex-row gap-12 md:items-center pt-8">
        ...
        <div className="flex flex-col gap-4 md:w-1/2">
          ...
          <p className="text-lg md:text-xl">{state.description}</p>
